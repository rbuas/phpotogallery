browserext = (function ($, Modernizr) {
    ...
    var browserext = {
        ...
        eParam: function(param, str) {
            ...
            var params = str.indexOf("&") >= 0 ? str.split(/[&]/) : [str];
            for (var i in params) {
                ...
                var value = decodeURI(splitParam[1]);
                if (key == param)
                    return !value || value.indexOf("|") < 0 ? value : value.split("|");
            }
            return null;
        },
        eParams: function(str) {
            ...
            for (var i in params) {
                ...
                var key = splitParam[0];
                var value = decodeURI(splitParam[1]);
                oParams[key] = !value || value.indexOf("|") < 0 ? value : value.split("|");
            }
