...
class User {
    ...
    public function __construct ($email, $password = NULL, $lang = NULL, $news = NULL, $status = NULL, $token = NULL, $passport = [], $favorite = [], $history = [], $uid = NULL) {
        $this->email = $email;
